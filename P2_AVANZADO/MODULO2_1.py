import MODULO1_1;    #De esta manera se importa un módulo
...
from MODULO1_1 import saludar, saludar2;  #De esta manera importamos únicamente alguna función del MODULO, por lo que ya no es necesario importar todo el MODULO

saludo = MODULO1_1.saludar("Jake");  #De esta manera se manda a llamar al módulo, pasa a funcionar como si fuera un objeto
